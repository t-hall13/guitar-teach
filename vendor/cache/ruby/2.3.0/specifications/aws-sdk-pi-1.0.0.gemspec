# -*- encoding: utf-8 -*-
# stub: aws-sdk-pi 1.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2018-05-29"
  s.description = "Official AWS Ruby gem for AWS Performance Insights (AWS PI). This gem is part of the AWS SDK for Ruby."
  s.email = ["trevrowe@amazon.com"]
  s.homepage = "http://github.com/aws/aws-sdk-ruby"
  s.licenses = ["Apache-2.0"]
  s.rubygems_version = "2.5.1"
  s.summary = "AWS SDK for Ruby - AWS PI"
