...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<actionmailer>, ["< 6", ">= 3.2"])
      s.add_runtime_dependency(%q<activemodel>, ["< 6", ">= 3.2"])
    else
      s.add_dependency(%q<actionmailer>, ["< 6", ">= 3.2"])
      s.add_dependency(%q<activemodel>, ["< 6", ">= 3.2"])
    end
  else
    s.add_dependency(%q<actionmailer>, ["< 6", ">= 3.2"])
    s.add_dependency(%q<activemodel>, ["< 6", ">= 3.2"])
